...
/*
 * This is our depot-side Autonomous code. It lands the robot from the lander, moves itself
...
public class AutonD extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
         ...
         * moves backward then right to adjust its position, moves backward toward the depot,
